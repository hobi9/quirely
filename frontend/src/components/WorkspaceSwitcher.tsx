...
const WorkspaceSwitcher = () => {
  return (
    <Popover>
      <PopoverTrigger className="group">
        <div className="flex items-center gap-x-4 transition group-hover:opacity-75">
          <div className="flex items-center gap-x-2 ">
            <div className="flex size-9 items-center justify-center rounded-md bg-red-500 text-slate-50">
              <Building size={28} />
            </div>
      ...
      <PopoverContent>
        <div className="flex items-center gap-x-2">
          <div className="flex size-11 items-center justify-center rounded-md bg-red-500 text-slate-50">
            <Building size={40} />
          </div>
